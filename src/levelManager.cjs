class LevelManager {
  constructor(){
    ...
    this.phases = [
      { id:1, name:'Country Roads', duration:20, baseSpeed:1.0, spawnRate:0.5 },
      { id:2, name:'Mountain Pass', duration:40, baseSpeed:1.3, spawnRate:0.8 },
      { id:3, name:'Desert Highway', duration:80, baseSpeed:1.6, spawnRate:1.2 },
